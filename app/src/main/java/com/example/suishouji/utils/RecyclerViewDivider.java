...
* */
    ...
    public RecyclerViewDivider(Context context,int orientation) {
        ...
        //mItemSize =  TypedValue.applyDimension((int) Math.max(mItemSize,1), TypedValue.COMPLEX_UNIT_DIP,context.getResources().getDisplayMetrics());
    ...
    private void drawVertical(Canvas canvas,RecyclerView parent){
        ...
        final float childSize = parent.getChildCount() ;
    ...
    private void drawHorizontal(Canvas canvas,RecyclerView parent){
        ...
        final float bottom = parent.getMeasuredHeight() - parent.getPaddingBottom() ;
    ...
    public void getItemOffsets(Rect outRect, View view, RecyclerView parent, RecyclerView.State state) {
        if(mOrientation == LinearLayoutManager.VERTICAL){
            outRect.set(0,0,0,(int) Math.max(mItemSize,1));
        }else {
            outRect.set(0,0,(int) Math.max(mItemSize,1),0);
        }
    }
}
